...
const defaultBooks: BookType[] = [
  ...
  {
    id: "default_2",
    title: "ประวัติศาสตร์ไทย - สุโขทัย",
    url: "https://th.wikipedia.org/wiki/อาณาจักรสุโขทัย",
    description: "ประวัติศาสตร์อาณาจักรสุโขทัย",
    type: "url",
  ...
  {
    id: "default_3",
    title: "วรรณกรรมไทย - ขุนช้างขุนแผน",
    url: "https://th.wikipedia.org/wiki/ขุนช้างขุนแผน",
    description: "เรื่องราวของขุนช้างขุนแผน",
    type: "url",
    category: "วรรณกรรม",
    language: "th",
  },
              ...
              <TabsContent value="text" className="space-y-6 mt-6">
                <div className="mb-4">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    💡 สามารถใส่ข้อความผสมหลายภาษาได้ เช่น "สวัสดี Hello 你好" ระบบจะอ่านได้ทั้งหมด
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      รองรับ: ไทย, English, 中文, 日本語, 한국어 และสามารถผสมกันในประโยคเดียวได้
                    </p>
                  </div>
